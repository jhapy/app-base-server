...
public abstract class BaseRelationaldbV2Endpoint<T extends BaseEntity, D extends BaseEntityLongId> implements
    HasLogger {
  ...
  public ResponseEntity<ServiceResult> countAnyMatching(@RequestBody CountAnyMatchingQuery query) {
    ...
    return handleResult(loggerPrefix,
        getService().countAnyMatching(query.getQueryUsername(),query.getFilter(), query.getShowInactive()));
  }
