 ...
 */
@Component
public class MessageTrlServiceFallback
    implements MessageTrlService, HasLogger, FallbackFactory<MessageTrlService> {
  ...
  @Override
  public ServiceResult<List<MessageTrlDTO>> findByMessage(FindByMessageQuery query) {
  ...
  @Override
  public ServiceResult<List<MessageTrlDTO>> findByIso3(FindByIso3Query query) {
  ...
  @Override
  public ServiceResult<MessageTrlDTO> getByNameAndIso3(GetByNameAndIso3Query query) {
  ...
  @Override
  public ServiceResult<MessageTrlDTO> getById(GetByIdQuery query) {
  ...
  @Override
  public ServiceResult<MessageTrlDTO> save(SaveQuery<MessageTrlDTO> query) {
