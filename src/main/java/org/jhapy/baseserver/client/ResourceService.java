 ...
 * @since 2019-05-15
 */
@AuthorizedFeignClient(name = "${jhapy.remote-services.resource-server.name:null}", url = "${jhapy.remote-services.resource-server.url:}", path = "/api/resourceService", fallbackFactory = ResourceServiceFallback.class)
@Primary
